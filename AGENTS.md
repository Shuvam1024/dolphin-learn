...
4. Do not start Vault/RAG/sandbox before v0.1 ships (`06-first-ship-plan.md`, S96). AI only behind the Phase 5 flag; a model may explain or draft, never grade or write evidence.
