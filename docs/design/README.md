...
2. Implement one step at a time: `03-build-plan.md` for S01–S50 (done), then `06-first-ship-plan.md`. **S51–S104 are done.** Next incomplete step is **S105 (tag v0.1.0)** if not yet tagged.
