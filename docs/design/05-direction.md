...
| 4 — Organized in one place, adaptive to time | S71–S80 | **Next** — priority shapes the plan; Home v2; Learn shelf; mobile tabs; path + replan; plan explainer; Progress by goal; reviews with what fits |
