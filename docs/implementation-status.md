...
- **Milestone completed:** S01–S09 (layout through lint, types, and tests)
- **Verified working user journey:** None yet (branded placeholder home only)
- **Implemented modules/features:** Layout; README + `.env.example`; local Postgres; FastAPI `GET /health`; Next.js placeholder at `/`; Clear Depth tokens; `/api/v1` plus error envelope; SQLAlchemy 2 session and Alembic baseline; ruff/mypy/pytest and ESLint/tsc/Vitest
...
- **Completed steps:** **S01–S09**
- **Next step:** **S10 — Integrate managed auth and map `auth_subject`**
...
|---|---|---|
| 0 | Foundation (S01–S19) | In progress (S01–S09 done) |
