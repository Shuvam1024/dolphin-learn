...
5. Keep `docs/implementation-status.md` current after every completed step.
...
**Companion docs:** `dolphin-master-design.md` (spec), `project-context.md` (locks), `implementation-status.md` (tracker).
...
| **Files/areas** | `docs/implementation-status.md`, short demo script in README or `docs/`; known limitations (no Vault/AI/sandbox) |
